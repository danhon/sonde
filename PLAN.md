...
This is the **design**: what was measured, what follows from it, and the rules
the code has to obey. It is not a changelog.

| | |
|---|---|
| [README.md](README.md) | What it is, how to run it, how to deploy it |
| [HISTORY.md](HISTORY.md) | What was built, in order, and why — including what was killed |
...
| M7b | Link signals from bios | ✅ done | GDELT and LinkedIn **dropped on evidence** — see [HISTORY.md](HISTORY.md) |
...
| M32 | Circle toggle chips | ✅ done | One gesture either way, 44px targets, no reload. Fixed three bugs, two of them shipped by M29 |
| M13 | Remaining extras | ⬜ optional | Bluesky list writing, RSS, per-DID rate-limit test |

The reasoning behind each of these — what was tried, what was measured, what was
killed before it shipped — is in [HISTORY.md](HISTORY.md).
...
Known defects are tracked separately in [BUGS.md](BUGS.md).
